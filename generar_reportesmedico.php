...
$sql = "SELECT * FROM medico where estatus = 1";
$resultado = $conexion->query($sql);

// Crear el contenido del reporte en HTML
$html = '<h1 style="color: #FF0000;">Reporte de Medicos</h1>';
$html .= '<table style="border-collapse: collapse;">';
$html .= '<tr><th style="background-color: 

#CCCCCC;">Nombre</th><th style="background-color: 
#CCCCCC;">Ap.Paterno</th><th style="background-color:
#CCCCCC;">Ap.Materno</th><th style="background-color:
#CCCCCC;">Especialidad</th><th style="background-color:
#CCCCCC;">Telefono</th><th style="background-color: 
#CCCCCC;">Estatus</th></tr>';
...
$pdf->Output('reporte_Medico.pdf', 'I');
?>
