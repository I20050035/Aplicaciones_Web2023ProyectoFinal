...
<html>
    ...
    <body>
        <center>
        <form action="InsertRegistro.php" method="get">
            ...
            <input type="text" id="txtespecialidad" name="txtEspecialidad"><br>
            <label for = "telefono">Telefono:</label><br>
            <input type="text" id="txtTelefono" name="txtTelefono"><br><br>
